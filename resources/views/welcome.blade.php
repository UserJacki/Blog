...
@foreach ($temasDestacados as $temaDestacado)
    ...
    <div class="container-fluid">
                    ...
                    <div class="col-xs-12 col-lg-4">
                        <div class="jsNewsCard news__card" modal-id="{{ $articulo->id }}">
                            <div class="news__image">
                                <img class="news__img" alt="" src="{{ Storage::url('imageArticle/' .$articulo->imagenDestacada()) }}">
                            </div>
        ...
        <div data-app-prevent-settings="" class="modal fade" tabindex="-1" data-keyboard="true" data-interval="false" id="lb-news1-7_1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="card cart-block">
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                                <div class="card-img iconbox">
                                    <a href="https://mobirise.com" class="cm-icon cm-icon-note mbr-iconfont mbr-iconfont-features16" style="color: rgb(252, 122, 96); text-shadow: rgba(0, 0, 0, 0.298039) 0px 0px 20px, rgba(0, 0, 0, 0.0980392) -10px 10px 7px;"></a>
                                </div>
                            </div>
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                                <div class="text-xs-left">
...
@include('includes.login-modal') <!-- SE INCLUYE LA VISTA DEL LOGN MODAL  -->
@endsection
