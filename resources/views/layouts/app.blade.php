...
<head>
   ...
   <!-- <link rel="dns-prefetch" href="//fonts.gstatic.com">
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:400,700"> <!-- ADD BLOG-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:400,400i,700,700i"> <!-- ADD BLOG-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Arvo:400,400i,700,700i"> <!-- ADD BLOG-->

    <link rel="stylesheet" href="{{ asset('assets/bootstrap-material-design-font/css/material.css') }} "> <!-- ADD BLOG-->
            ...
            <div class="container-fluid">
                ...
                <div class="mbr-table">
                    ...
                    <div style="margin-top: 15px">
                        <form class="form-inline" method="GET" action="{{ route('buscador') }}">
                            @csrf
                            <div class="form-group">
                                <input type="text" class="form-control" id="exampleInputName2" name="busqueda" placeholder="Buscar...">
                            </div>
                        ...
                        <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    @foreach ($temasall as $tema)
                                        <a class="dropdown-item" href="{{ route('tema',$tema) }}">{{ $tema->nombre }} </a>
                            ...
                            @guest
                                ...
                                @if (Route::has('register'))
                                    <li class="nav-item">
                                        <a class="nav-link link" href="{{ route('register') }}">{{ __('REGISTRO') }}</a>
                                    </li>
                                @endif
                            @else
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        ...
                                        @if (auth()->user()->hasRole('administrador'))
                                            <a class="dropdown-item" href="{{ route('admintema') }}">Zona Admintrador</a>
                                        @endif
                                        @if (auth()->user()->hasRole('moderador'))
                                            <a class="dropdown-item" href="{{ url('moderador/articulos') }}">Zona Moderador</a>
                                        @endif
                                        <a class="dropdown-item" href="{{ route('home') }}">Zona Privada </a>
...
@yield('content')
    ...
    <script src="{{ asset('js/app.js') }}" defer></script><!-- ya estaba PREDEFINIDO en la parte de arriba  -->

    @yield('include-login-modal') <!-- se incluye lo del modal -->
