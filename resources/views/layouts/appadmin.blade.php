    ...
    <section class="menu1" id="menu-0" data-rv-view="0">
        <nav class="navbar navbar-dropdown navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="mbr-table">
                    <div class="mrt-table-cell"> </div>
                    <!-- ZONA USUARIO -->
                    <div class="mrt-table-cell">
                        <div class="navbar-brand">
                            <a href="#" class="navbar-caption">@yield('rol', 'Zona Administrador') / {{ $miga }}</a>
                        </div>
                    </div>
                    <!-- ZONA USUARIO -->
                    <div class="mbr-table-cell">
                        ...
                        <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-xl" id="exCollapsingNavbar">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link" href="{{ route('admintema') }}" aria-expanded="false">Temas</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <!-- END NUEVO CONTENIDO PÁRA EL ADMIN -->
...
@yield('content')
    ...
    <!-- <script src="#" defer></script> ya estaba PREDEFINIDO en la parte de arriba  -->

    <!-- ('include-login-modal')  se incluye lo del modal -->
