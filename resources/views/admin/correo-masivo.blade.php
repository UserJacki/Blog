...
<form method="POST" action="{{ url('admin/correo-masivo') }}" enctype="multipart/form-data" class="temaFormuEdit">
	@csrf
	<div style="margin-top: 150px; margin-bottom: 180px;" class="container">
	    ...
	    <div class="row">
	        ...
	        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
				...
				<hr>
	            <button type="submit" class="btn btn-info btn-sm">Enviar Correo</button>
	        </div>
	    </div>
	</div>
</form>
